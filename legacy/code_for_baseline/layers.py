...
class AbsolutePositionalEmbedding(nn.Module):
    def __init__(self, dim, max_seq_len, l2_norm_embed = False):
        super().__init__()
        self.scale = dim ** -0.5 if not l2_norm_embed else 1.
        self.max_seq_len = max_seq_len
        self.l2_norm_embed = l2_norm_embed
    ...
    def forward(self, x, pos = None):
        ...
        return self.l2_norm(pos_emb) if self.l2_norm_embed else pos_emb
