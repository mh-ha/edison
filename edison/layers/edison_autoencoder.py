...
class EdisonPerceiverAttention(nn.Module):
    ...
    def forward(
        self,
        x: torch.Tensor,
        latents_c1: torch.Tensor,
        latents_c0: torch.Tensor,
        consciousness_mask: torch.Tensor = None,
...
class EdisonPerceiverResampler(nn.Module):
    ...
    def forward(self, x: torch.Tensor, consciousness_mask: torch.Tensor) -> dict[str, torch.Tensor]:
...
class EdisonPerceiverAutoEncoder(nn.Module):
    ...
    def decode(
        self,
        ae_latent: dict[str, torch.Tensor]
